...
minv_slow = pyproximal.optimization.primal.ProximalGradient(
    l2, ind, tau=0.0005, x0=m0, epsg=1.0, niter=10, callback=callback
)
...
minv_opt = pyproximal.optimization.primal.ProximalGradient(
    l2, ind, tau=tau_opt, x0=m0, epsg=1.0, niter=10, callback=callback
)
...
minv_back = pyproximal.optimization.primal.ProximalGradient(
    l2, ind, tau=None, x0=m0, epsg=1.0, niter=10, niterback=4, callback=callback
)
